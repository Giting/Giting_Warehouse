...
import com.giting.pm.service.IPmFamilyroomService;
import com.opensymphony.xwork2.ActionSupport;
/**   
*    
* 项目名称：WCCAMS   
* 类名称：BeDictionaryclassAction   
* 类描述：  家庭房间对应关系表对应的数据交换层
...
*    
*/ 
@Controller("pmFamilyroomAction")
public class PmFamilyroomAction extends ActionSupport{
